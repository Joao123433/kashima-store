...
class ClothingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothing" do
    assert_difference("Clothing.count") do
      post clothings_url, params: { clothing: { description: @clothing.description, label: @clothing.label, path: @clothing.path, price: @clothing.price, quant: @clothing.quant } }
    end
  ...
  test "should update clothing" do
    patch clothing_url(@clothing), params: { clothing: { description: @clothing.description, label: @clothing.label, path: @clothing.path, price: @clothing.price, quant: @clothing.quant } }
